...
Ca0b0 = m.constructClause([aminus, bminus])
Ca0b1 = m.constructClause([aminus, bplus])
Ca1b0 = m.constructClause([aplus, bminus])
Ca1b1 = m.constructClause([aplus, bplus])

Ca0b0c0 = m.constructClause([aminus, bminus, cminus])
Ca1b1c1 = m.constructClause([aplus, bplus, cplus])
